...
## Extensions
    ...
    #   rho = 0.0, # scaling of political gain from war as a function of distance. Set to 0 to make all defections equally valuable for increasing power
       wardecay=0.0, # decay rate of war effects with distance. Set to 0 to disable the spatial model
...
An example of the spatial model will be put here.
